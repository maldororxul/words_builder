...
class StatsManager(private val context: Context) {
    ...
    var totalWordsSolved: Int
        ...
        set(value) = prefs.edit().putInt(KEY_WORDS_SOLVED, value).apply()
    ...
    fun addUniqueWord(word: String) {
        ...
        if (uniqueWords.add(word.lowercase())) {
            ...
            prefs.edit().putString(KEY_UNIQUE_WORDS, json).apply()
        }
    }
    ...
    var hintsUsed: Int
        ...
        set(value) = prefs.edit().putInt(KEY_HINTS_USED, value).apply()
}
